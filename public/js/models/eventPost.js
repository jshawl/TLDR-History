...
EventPost.fetch = function() {
  var request = $.getJSON("https://localhost:3000/eventPosts")
...
EventPost.prototype = {
  fetchTldrs: function() {
    var url = "https://localhost:3000/eventposts/" + this.id + "/tldrs";
  ...
  update: function(eventPostData) {
    ...
    var url = "https://localhost:3000/eventposts/" + this.id;
    var request = $.ajax({
      url: url,
      method: "patch",
